...
SMTP_USER = EMAIL  # Your Gmail username
SMTP_PASSWORD = "qhzrfgwnpratgdgc" # Your Gmail password or App Password
SENDER_EMAIL = EMAIL
RECEIVER_EMAIL = "test_recipient@example.com" # An email address you can check
